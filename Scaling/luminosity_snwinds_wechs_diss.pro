FUNCTION LUMINOSITY_SNWINDS_WECHS_DISS, t, r, v, q, lum_params;,h
	;PARA MI MEMORIA: LUM_PARAMS=[tau_sn,Mdm,z_*,little_h,t_start,L_scale]
	H_0 = 7.48609e-11;yr^-1
	omega_b = 0.0416
	f_m = 0.10
	eta = eta_calc(t,lum_params)
	t_real_here = t*lum_params[4] + lum_params[4]
	z_here = complete_z_to_t(t_real_here)
